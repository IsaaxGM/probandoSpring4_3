...
public interface CourseJpaReppsitory extends JpaRepository<Course, Serializable> {

	public abstract Course findByPrice(int price); //Hace un query automaticamente
