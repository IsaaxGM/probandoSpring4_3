...
public class Example2Controller {
	...
	//http://localhost:8080/example2/request1?nm=Isaac --> Forma 1 de recibir parametros
	@GetMapping("/request1")
	...
	//http://localhost:8080/example2/request2/ISAAC --> Forma 2 de recibir parametros en el path
